/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=/private/tmp/card-keepr-wave1-issue-45/apps/api/wrangler.jsonc /private/tmp/card-keepr-wave1-issue-45/apps/api/worker-configuration.d.ts` (hash: ba5ecd9ce606f3631b03fbfcb9dd7524)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CORS_ALLOWED_ORIGINS" | "API_BEARER_KEY" | "API_BEARER_KEY_REPLACEMENT" | "CREDENTIAL_CONSUMER_PROOF_KEY">> {}
}
