/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=/Users/marcus/Developer/card-keepr-worktrees/issue-272-toolchain/apps/api/wrangler.jsonc /Users/marcus/Developer/card-keepr-worktrees/issue-272-toolchain/apps/api/worker-configuration.d.ts` (hash: b071cbb37b230a6160feb712ed95f63f)
...
interface __BaseEnv_Env {
	...
	API_LIVENESS_RATE_LIMIT: RateLimit;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CORS_ALLOWED_ORIGINS" | "API_BEARER_KEY" | "API_BEARER_KEY_REPLACEMENT" | "PUBLIC_BASE_URL">> {}
}
