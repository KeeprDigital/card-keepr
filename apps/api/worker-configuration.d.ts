/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=/private/tmp/card-keepr-wave1-issue-45/apps/api/wrangler.jsonc /private/tmp/card-keepr-wave1-issue-45/apps/api/worker-configuration.d.ts` (hash: 35f904118cf516d92affc3d30f68d60b)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CORS_ALLOWED_ORIGINS" | "API_BEARER_KEY" | "API_BEARER_KEY_REPLACEMENT" | "CREDENTIAL_BOUNDARY_ATTESTATION_KEY">> {}
}
