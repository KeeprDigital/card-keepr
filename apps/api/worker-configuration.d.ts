/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=/Users/marcus/Developer/card-keepr/.claude/worktrees/disposable-db/apps/api/wrangler.jsonc /Users/marcus/Developer/card-keepr/.claude/worktrees/disposable-db/apps/api/worker-configuration.d.ts` (hash: 32c067c2e5557be5b2b45297fc8162d1)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CORS_ALLOWED_ORIGINS" | "API_BEARER_KEY" | "API_BEARER_KEY_REPLACEMENT">> {}
}
