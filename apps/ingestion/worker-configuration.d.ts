/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=/Users/marcus/Developer/card-keepr-worktrees/staging-same-zone-fetch/apps/ingestion/wrangler.jsonc /Users/marcus/Developer/card-keepr-worktrees/staging-same-zone-fetch/apps/ingestion/worker-configuration.d.ts` (hash: dd3571192e514be8ad0a1eb1412546b1)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ADMINISTRATION_CLOCK_MODE" | "SOURCE_HOST_PACING_MODE" | "SOURCE_HOST_PACING_INTERVAL_MS" | "CLOUDFLARE_ACCOUNT_ID" | "CATALOGUE_D1_DATABASE_ID" | "DISPOSABLE_D1_DATABASE_ID" | "KEEPR_ENVIRONMENT" | "ADMINISTRATION_KEY" | "ADMINISTRATION_KEY_REPLACEMENT" | "D1_EXPORT_TOKEN" | "D1_VERIFICATION_TOKEN" | "PUBLIC_BASE_URL">> {}
}
