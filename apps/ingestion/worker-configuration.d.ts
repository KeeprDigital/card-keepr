/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=/Users/marcus/Developer/card-keepr/.claude/worktrees/agent-a42fe2ddae550d395/apps/ingestion/wrangler.jsonc /Users/marcus/Developer/card-keepr/.claude/worktrees/agent-a42fe2ddae550d395/apps/ingestion/worker-configuration.d.ts` (hash: 57df41ed776098255dbba259dd8367dc)
...
interface __BaseEnv_Env {
	...
	ADMINISTRATION_RATE_LIMIT: RateLimit;
	ADMINISTRATION_CLOCK_MODE: "system";
	SOURCE_HOST_PACING_MODE: "production";
	CLOUDFLARE_ACCOUNT_ID: "3ec389380c7b82e6a172e6f351d4aad9";
	CATALOGUE_D1_DATABASE_ID: "c832fb49-abfc-48a4-80e3-f788b30d954f";
	DISPOSABLE_D1_DATABASE_ID: "720d71a4-bf57-4a88-b010-937786eddda4";
	GITHUB_REPOSITORY_ID: "1313489088";
	GITHUB_APP_ID: "0";
	GITHUB_INSTALLATION_ID: "0";
	GITHUB_ENVIRONMENT_ID: "0";
	GITHUB_WORKFLOW_ID: "0";
	...
	CLOUDFLARE_OBSERVATION_TOKEN: string;
	GITHUB_APP_PRIVATE_KEY: string;
	GITHUB_OBSERVATION_ACTOR: string;
	...
	API_CREDENTIAL_CONSUMER: Service /* entrypoint ApiCredentialConsumer from card-keepr-api */;
	OFFICIAL_SOURCE_TRANSPORT: Service<typeof import("./src/index").OfficialSourceTransport>;
	EVIDENCE_INGESTION_WORKFLOW: Workflow<Parameters<import("./src/index").EvidenceIngestionWorkflow['run']>[0]['payload']>;
	EVIDENCE_HOST_WORKFLOW: Workflow<Parameters<import("./src/index").EvidenceHostWorkflow['run']>[0]['payload']>;
	RECONCILIATION_WORKFLOW: Workflow<Parameters<import("./src/index").ReconciliationWorkflow['run']>[0]['payload']>;
	CATALOGUE_BACKUP_WORKFLOW: Workflow<Parameters<import("./src/index").CatalogueBackupWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ADMINISTRATION_CLOCK_MODE" | "SOURCE_HOST_PACING_MODE" | "CLOUDFLARE_ACCOUNT_ID" | "CATALOGUE_D1_DATABASE_ID" | "DISPOSABLE_D1_DATABASE_ID" | "GITHUB_REPOSITORY_ID" | "GITHUB_APP_ID" | "GITHUB_INSTALLATION_ID" | "GITHUB_ENVIRONMENT_ID" | "GITHUB_WORKFLOW_ID" | "ADMINISTRATION_KEY" | "ADMINISTRATION_KEY_REPLACEMENT" | "CREDENTIAL_BOUNDARY_ATTESTATION_KEY" | "CREDENTIAL_CONSUMER_PROOF_KEY" | "CLOUDFLARE_OBSERVATION_TOKEN" | "GITHUB_APP_PRIVATE_KEY" | "GITHUB_OBSERVATION_ACTOR" | "D1_EXPORT_TOKEN" | "D1_EXPORT_TOKEN_REPLACEMENT" | "D1_VERIFICATION_TOKEN" | "D1_VERIFICATION_TOKEN_REPLACEMENT">> {}
}
