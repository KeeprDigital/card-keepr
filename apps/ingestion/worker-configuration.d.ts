/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=/Users/marcus/Developer/card-keepr-worktrees/issue-272-toolchain/apps/ingestion/wrangler.jsonc /Users/marcus/Developer/card-keepr-worktrees/issue-272-toolchain/apps/ingestion/worker-configuration.d.ts` (hash: a61771d5f7294af592c482ba8bd96861)
// Runtime types generated with workerd@1.20260908.1 2026-07-29 nodejs_compat
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ADMINISTRATION_CLOCK_MODE" | "SOURCE_HOST_PACING_MODE" | "SOURCE_HOST_PACING_INTERVAL_MS" | "CLOUDFLARE_ACCOUNT_ID" | "CATALOGUE_D1_DATABASE_ID" | "DISPOSABLE_D1_DATABASE_ID" | "ADMINISTRATION_KEY" | "ADMINISTRATION_KEY_REPLACEMENT" | "D1_EXPORT_TOKEN" | "D1_VERIFICATION_TOKEN" | "PUBLIC_BASE_URL">> {}
}
