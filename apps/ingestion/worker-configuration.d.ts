/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=/Users/marcus/Developer/card-keepr/apps/ingestion/wrangler.jsonc /Users/marcus/Developer/card-keepr/apps/ingestion/worker-configuration.d.ts` (hash: 79f907ae4aef14ab755dfb90b5c0698f)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ADMINISTRATION_CLOCK_MODE" | "CLOUDFLARE_ACCOUNT_ID" | "CATALOGUE_D1_DATABASE_ID" | "DISPOSABLE_D1_DATABASE_ID" | "GITHUB_REPOSITORY_ID" | "ADMINISTRATION_KEY" | "ADMINISTRATION_KEY_REPLACEMENT" | "CREDENTIAL_BOUNDARY_ATTESTATION_KEY">> {}
}
