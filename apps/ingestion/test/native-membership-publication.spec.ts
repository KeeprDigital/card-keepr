...
describe("native membership history", () => {
  ...
  let asiaRevision: string;
  // Establish fresh, published and backup-verified history under the bounded
  // setup deadline. The test then exercises preservation, disappearance and replay.
  beforeEach(async () => {
    ...
    asiaRevision = requiredString(asiaPublished.document, "resulting_revision_id");
  });

  test("preserves unchecked lineages and accepts a repeated disappearance without changing facts", async () => {
