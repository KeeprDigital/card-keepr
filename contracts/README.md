...
| Contract             | Source                                                                                                                                                                                              |
| -------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Generated HTTP       | [Read OpenAPI](read-openapi.json), [administration OpenAPI](admin-openapi.json), [HTTP boundary and documentation access](HTTP.md) and [complete route/caller inventory](http-route-inventory.json) |
...
| Owner administration | [Administration contract](ADMINISTRATION.md) and [historical snapshot schema](schemas/administration.schema.json)                                                                                   |
...
Current administration request definitions are generated from the executable
route schemas. The separate administration schema retains historical snapshot
decoding; it does not describe current status or authorize run-owned publication.
