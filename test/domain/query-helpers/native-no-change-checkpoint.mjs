export function seedAcceptanceCheckpoint(db) {
  db.exec(`CREATE TABLE catalogue_revisions(id TEXT PRIMARY KEY, publication_operation_id TEXT);
    ...
    CREATE TABLE catalogue_backup_attempts(idempotency_key TEXT PRIMARY KEY,request_json TEXT,owner_token TEXT,
      ...
      publication_operation_id TEXT,publication_ingestion_run_id TEXT,d1_bookmark TEXT,manifest_sha256 TEXT);
    INSERT INTO catalogue_revisions VALUES('revision','original');
