...
// Temporary synthetic-owner diagnostic: at most one receipt and two 4 MiB SQL files.
export async function retainOwnerImportFailure({ directory, uploaded, exported, metadata }) {
  ...
  if (Buffer.byteLength(receipt) > receiptLimit) throw new Error("Owner import receipt exceeds 16 KiB.");
